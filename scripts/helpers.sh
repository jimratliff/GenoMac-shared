...
source_with_report "${this_script_dir}/helpers-files.sh"
...
source_with_report "${this_script_dir}/helpers-json.sh"
source_with_report "${this_script_dir}/helpers-logging.sh"
source_with_report "${this_script_dir}/helpers-migrate.sh"
source_with_report "${this_script_dir}/helpers-mac-and-terminal-environment.sh"
source_with_report "${this_script_dir}/helpers-reporting.sh"
source_with_report "${this_script_dir}/helpers-shell-ish.sh"
...
# Requires set_env_var_if_not_set() from helpers-misc.sh, and thus is sourced after the helpers
