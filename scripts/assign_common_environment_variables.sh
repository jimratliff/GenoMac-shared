...
GENOMAC_STATE_USER_HAS_BEEN_CREATED_PREFIX="USER_HAS_BEEN_CREATED"
GENOMAC_STATE_USER_HAS_BEEN_CONFIGURED_PREFIX="USER_HAS_BEEN_CONFIGURED"
...
export_and_report GENOMAC_STATE_USER_HAS_BEEN_CONFIGURED_PREFIX
export_and_report GENOMAC_STATE_USER_HAS_BEEN_CREATED_PREFIX
