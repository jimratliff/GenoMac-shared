...
GENOMAC_STATE_VOLUME_IS_PENDING_PREFIX="VOLUME_CREATION_IS_PENDING_"
GENOMAC_STATE_VOLUME_IS_CREATED_PREFIX="VOLUME_CREATION_IS_COMPLETE_"
...
export_and_report GENOMAC_STATE_VOLUME_IS_CREATED_PREFIX
export_and_report GENOMAC_STATE_VOLUME_IS_PENDING_PREFIX
